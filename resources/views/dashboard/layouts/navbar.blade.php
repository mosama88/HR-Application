                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('dashboard') }}/assets/img/avatars/2.png" alt
                                                class="w-px-40 h-auto rounded-circle" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('dashboard') }}/assets/img/avatars/9.png" alt
                                                class="w-px-40 h-auto rounded-circle" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('dashboard') }}/assets/img/avatars/5.png" alt
                                                class="w-px-40 h-auto rounded-circle" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('dashboard') }}/assets/img/avatars/6.png" alt
                                                class="w-px-40 h-auto rounded-circle" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                ...
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        @if (Auth::user()->gender == AdminGenderEnum::Male)
                            <img src="{{ asset('dashboard') }}/assets/img/employees-default.png"
                                class="w-px-40 h-auto rounded-circle" alt="User Image">
                        @elseif (Auth::user()->gender == AdminGenderEnum::Female)
                            <img src="{{ asset('dashboard') }}/assets/img/employees-female-default.png"
                                class="w-px-40 h-auto rounded-circle" alt="User Image">
                        @else
                            <img src="{{ asset('dashboard') }}/assets/img/avatar5.png"
                                class="w-px-40 h-auto rounded-circle" alt="User Image">
                        @endif
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <form action="{{ route('logout') }}" method="POST">
                            @csrf
                            <button type="submit" class="dropdown-item" target="_blank">
