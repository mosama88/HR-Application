        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                @if (Auth::user()->gender == AdminGenderEnum::Male)
                    <img src="{{ asset('dashboard') }}/assets/img/employees-default.png" class="img-circle elevation-2"
                        alt="User Image">
                @elseif (Auth::user()->gender == AdminGenderEnum::Female)
                    <img src="{{ asset('dashboard') }}/assets/img/employees-female-default.png"
                        class="img-circle elevation-2" alt="User Image">
                @else
                    <img src="{{ asset('dashboard') }}/assets/img/avatar5.png" class="img-circle elevation-2"
                        alt="User Image">
                @endif
