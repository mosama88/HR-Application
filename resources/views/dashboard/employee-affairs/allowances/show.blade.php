...
@section('title', 'عرض بيانات البدلات')
@push('css')
@endpush
@section('content')
    ...
    @include('dashboard.layouts.breadcrumb', [
        ...
        'currentPage' => 'عرض بيانات البدلات',
    ])
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <div class="col-md-12">
                            <h5 class="card-header">عرض بيانات البدلات</h5>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input readonly name="name" type="text"
                                            value="{{ old('name', $allowance->name) }}" class="form-control"
